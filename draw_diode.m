...
D1rx1=[xref xref+1 xref+0.5 xref xref+0.5 xref+1 xref xref+1 xref+0.5 xref+0.5];
D1ry1=[yref yref yref yref-1 yref yref-1 yref-1 yref-1 yref yref+2];
D1rx2=[xref+0.5 xref+0.5];
D1ry2=[yref-mp yref-1];
